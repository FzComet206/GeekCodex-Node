...
exports.FETCH_LIKE_INFO = exports.FETCH_FOLLOWING_INFO = exports.FETCH_FOLLOWER_INFO = exports.SET_USER_FOLLOWS = exports.DELETE_USER_FOLLOWS = exports.FETCH_LIKED_POSTS_SEARCH = exports.FETCH_LIKED_POSTS_SORT_LIKE = exports.FETCH_LIKED_POSTS = exports.FETCH_SELF_POSTS_SEARCH = exports.FETCH_SELF_POSTS_SORT_LIKE = exports.FETCH_SELF_POSTS = exports.FETCH_POSTS_SEARCH = exports.FETCH_POSTS_SORT_LIKE = exports.FETCH_POSTS = void 0;
exports.FETCH_POSTS = `
...
exports.FETCH_SELF_POSTS = `
        ...
        LIMIT $1 OFFSET $2;
    `;
exports.FETCH_SELF_POSTS_SORT_LIKE = `
        SELECT posts.* , users.username AS author 
        FROM posts
        JOIN users ON posts.userid = users.id
        WHERE posts.userid = $3
        ...
        LIMIT $1 OFFSET $2;
    `;
exports.FETCH_SELF_POSTS_SEARCH = `
        SELECT posts.* , users.username AS author 
        FROM posts
        JOIN users ON posts.userid = users.id
...
exports.FETCH_LIKED_POSTS = `
        ...
        LIMIT $2 OFFSET $3;
    `;
exports.FETCH_LIKED_POSTS_SORT_LIKE = `
        SELECT posts.* , users.username AS author 
        FROM posts
        JOIN users ON posts.userid = users.id
        JOIN likes ON posts.id = likes.postid
        ...
        LIMIT $2 OFFSET $3;
    `;
exports.FETCH_LIKED_POSTS_SEARCH = `
        SELECT posts.* , users.username AS author 
        FROM posts
        JOIN users ON posts.userid = users.id
        JOIN likes ON posts.id = likes.postid
